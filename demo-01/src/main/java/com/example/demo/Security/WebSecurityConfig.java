...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.cors().disable().csrf().disable()
                ...
                .antMatchers("/confirm*").permitAll() // anyone can access
...
//                .antMatchers("/style.css").permitAll()// anyone can access
                ...
                .permitAll()
//                .loginProcessingUrl("/login") // process the login after submit
//                .defaultSuccessUrl("/home") // success login go to route /hello
